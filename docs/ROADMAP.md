...
| [#114](https://github.com/TIshow/ir-faq-mvp/issues/114) | feat | 事業 | [配信] 埋め込みウィジェット（発行体IRサイト＋日本証券新聞社ライブラリ・2027年2月） |
...
| Issue | 種類 | 領域 | 内容 |
|---|---|---|---|
| [#171](https://github.com/TIshow/ir-faq-mvp/issues/171) | feat | 事業 | [IRインテリジェンス] 開示の効果測定: 株価・出来高 × 開示日 × 質問ログ を1枚にする |
...
| Issue | 完了日 | 内容 |
|---|---|---|
| [#167](https://github.com/TIshow/ir-faq-mvp/issues/167) | 2026-08-07 | fix(ci): ROADMAP の同期チェックを外す（Issueを閉じるたびに必ず落ちる） |
...
| [#146](https://github.com/TIshow/ir-faq-mvp/issues/146) | 2026-08-07 | 層1の売上高カバレッジ 93.6% → 98.9%（業種別・IFRSの要素をマップに足す） |
